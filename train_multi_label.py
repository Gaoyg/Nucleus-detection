import os
os.environ['CUDA_VISIBLE_DEVICES'] = '0, 1' #'3,2,1,0'
...
#from net.se_resnext101_unet_multi_label.model import *
from models.se_resnext50_unet_multi_label.model import *
Net = UNet
...
def run_train():
    ...
    out_dir = RESULTS_DIR + '/unet-se-resnext50-multi-2a'
    initial_checkpoint = \
        RESULTS_DIR + '/unet-se-resnext50-multi-2a/checkpoint/00003000_model.pth'
        #
    ...
    while  i<num_iters:  # loop over the dataset multiple times
        ...
        for inputs, foregrounds_truth, cuts_truth, images, masks_truth, indices in train_loader:
            ...
            if LR is not None:
                ...
                adjust_learning_rate(optimizer, lr_base* (0.1 ** (epoch // 550)))
